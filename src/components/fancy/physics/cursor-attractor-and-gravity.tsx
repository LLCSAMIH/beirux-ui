  ...
  (
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        // Strip null chamfer to satisfy matter-js types (registry ships IBodyDefinition
        // which allows null, but Bodies.* expect IChamferableBodyDefinition where chamfer
        // must be IChamfer | undefined).
        const { chamfer: _chamfer, ...safeBodyOptions } = props.matterBodyOptions ?? {}
        const bodyOptions = {
          ...safeBodyOptions,
          ...(_chamfer != null ? { chamfer: _chamfer } : {}),
        }

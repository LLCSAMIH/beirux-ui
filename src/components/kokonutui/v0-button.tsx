...
export default function V0Button({
  ...
  return (
    <Button aria-label="Open in v0" className={cn(
              ...
              className
            )} render={<a href={`https://v0.dev/chat/api/open?url=${prePath}/r/${name}.json`} rel="noreferrer" target="_blank" />} nativeButton={false}>Open in{" "}<svg
